            ...
            <div class="col-sm-8 col-md-8">
                ...
                <!-- show post by catagory  - WHERE post_category_id = $cat_id -->
                    <?php
                        // user
                        $post_tag2 = $_GET['post_tag2'];
                        $sql5 = "SELECT * FROM users WHERE username ='$post_tag2'"; 
                        ...
                        confirm_query($result);
                            if (mysqli_num_rows($result) > 0) {      
                                 $par_page=10;
                                    ...
                                    $post_count_query = "SELECT * FROM post JOIN users ON post.user_id = users.id WHERE users.username ='$post_tag2' AND post.post_status = 'publish' ORDER BY post_id DESC";
                                    $fine_count = mysqli_query($con,$post_count_query);
                                    $count = mysqli_num_rows($fine_count);
                                    $count = ceil($count/$par_page);

                            $sql = "SELECT * FROM post JOIN users ON post.user_id = users.id WHERE users.username ='$post_tag2' AND post.post_status = 'publish' ORDER BY post_id DESC LIMIT $page_one,$par_page";                    
                                ...
                                <ul>
                                    <?php
                                        $post_tag2 = $_GET['post_tag2'];
                                            for($i=1;$i<=$count;$i++){
                                                if($i == $page){
                                                    echo "<li><a class='active_link' href='search_user.php?post_tag2=$post_tag2&page=$i'>$i</a></li>";     
                                                }else{
                                                    echo "<li><a href='search_user.php?post_tag2=$post_tag2&page=$i'>$i</a></li>"; 
                                                }                        
                                            }                
                                      ?>
                                </ul>
      ...
      <div class="widget-sub-s">
        ...
        <div class="widget">
                ...
                <div class="panel-body">
                    <?php 
                        $post_tag2 = $_GET['post_tag2'];
                        $sql = "SELECT * FROM users WHERE username = '$post_tag2'";
                                    ...
                                    <div class="row"> 
                                     ...
                                     <!-- row -->
                                        <div class="col-md-6">
                                            ...
                                            if(isset($_SESSION['USER']->id)) {
                                            ?>
                                                <i class="fa-brands fa-facebook-messenger fa-1x"></i> <a href="../ChatApp/users.php" style="text_decoration:none;"><b><h4 style="color:darkorange;">Chat</h4><b></a>
                                            <?php
                                            }
                                            ?>                                     
                                        </div>
