        ...
        <div class="row">
           ...
           <!-- show post -->
                ...
                if(!isset($_SESSION['USER']->id)) 
                {
                    ...
                    WHERE post_status = 'publish' AND users.username = 'Admin' 
                    ...
                    WHERE post.post_status = '". $status."' AND (tbl_follow.receiver_id = '". $_SESSION['USER']->id."' OR post.user_id = '". $_SESSION['USER']->id."' OR users.username = '".$Admin."') GROUP BY post.post_id ORDER BY post.post_id DESC
                              ";
                    $fine_count = mysqli_query($con,$post_count_query);
                    $count = mysqli_num_rows($fine_count);
                    $count = ceil($count/$par_page);                              
                ...
                ?>
                    ...
                    <?php
                                if($post_image == ''){
                                     echo ' <img src="../img/default_p.png"
